package net.hafiznaufalr.kiwari_androidtest.ui
...
//    }
    ...
    private fun saveUserToFirebaseDatabase() {
        ...
        val user = User(uid,"https://api.adorable.io/avatars/160/ismail@mail.com.png", email_edittext_register.text.toString(), name_edittext_register.text.toString(), password_edittext_register.text.toString())
